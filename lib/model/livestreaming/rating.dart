...
class _RatingScreen extends State<RatingScreen> {
  ...
  Future<DocumentSnapshot> get() async{
    return await FirebaseFirestore.instance.collection('Trips').doc(this.widget.id).get();
  }
  @override
                ...
                Container(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () async{
                      ...
                      await FirebaseFirestore.instance.collection('Dictionary').doc('rating').update(
                          {
                            place: [list[0] + 1, list[1] + _rating]
                          }
                      );
                      await FirebaseFirestore.instance.collection('Trips').doc(this.widget.id).update(
                          {
                            "Rating": (list[1]+_rating)/(list[0]+1)
                          }
                      );
